          ...
          <div className={`flex flex-col gap-2 ${selectMenu === "my-info" ? "block" : "hidden"}`} >
            <div className="w-ful rounded-2xl p-2 bg-white dark:bg-[#111728]">
              ...
              <div className="flex flex-col items-start m -mt-[70px] p-5 ">
                ...
                <button onClick={() => document.getElementById('my_profile_info_update').showModal()} className="mt-4 btn rounded-full bg-gradient-to-r from-[#eed9ed]/50 dark:from-[#eed9ed]/10 to-[#2ec05a]/20 dark:border-gray-600 border-[#333] shadow-md  transition">
