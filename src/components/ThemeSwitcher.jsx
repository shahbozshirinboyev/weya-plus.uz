    ...
    <div className="p-[2px] w-auto inline-block border border-gray-300 dark:border-gray-600 rounded-md">
      <div className="flex justify-between items-center w-[90px] h-[30px] relative">
        ...
        <div
          ...
          className={`w-[30px] h-[30px] flex justify-center items-center p-2 z-10 cursor-pointer ${ theme === 'light' ? "text-gray-50" : "" }`}
        >
        ...
        <div
          ...
          className={`w-[30px] h-[30px] flex justify-center items-center p-2 z-10 cursor-pointer ${ theme === 'night' ? "text-gray-900" : "" }`}
        >
        ...
        <div
          ...
          className={`w-[30px] h-[30px] flex justify-center items-center p-2 z-10 cursor-pointer ${ isDarkMode && theme === 'system' ? "text-gray-900" : "" } ${ !isDarkMode && theme === 'system' ? "text-gray-50" : "" }`}
        >
