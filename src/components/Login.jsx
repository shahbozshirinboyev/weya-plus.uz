  ...
  return (
    <>
      ...
      <dialog id="login" className="modal glass">
        <div className="modal-box max-w-md border border-gray-300 dark:border-gray-600 bg-base-200 bg-gradient-to-r from-[#eed9ed]/60 dark:from-[#eed9ed]/10 to-[#2ec05a]/10">
          ...
          <form action="" className="flex flex-col justify-center items-center gap-2 mb-8">
            <label className="input border border-gray-300 dark:border-gray-600 bg-base-200 bg-gradient-to-r from-[#eed9ed]/60 dark:from-[#eed9ed]/10 to-[#2ec05a]/10">
            ...
            <button className="btn w-[320px] flex justify-center items-center gap-3 mt-4 border border-gray-300 dark:border-gray-600 bg-base-200 bg-gradient-to-r from-[#eed9ed]/60 dark:from-[#eed9ed]/10 to-[#2ec05a]/10">
            ...
            <button className="btn w-[320px] flex justify-center items-center gap-3 border border-gray-300 dark:border-gray-600 bg-base-200 bg-gradient-to-r from-[#eed9ed]/60 dark:from-[#eed9ed]/10 to-[#2ec05a]/10">
              <i className="bi bi-google opacity-70"></i>
